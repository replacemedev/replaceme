...
export function AdminFilterPills({
  ...
  return (
    <div className="w-full overflow-x-auto pb-2 -mb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-xs font-semibold transition-colors shadow-xs shrink-0 capitalize ${
                isActive
