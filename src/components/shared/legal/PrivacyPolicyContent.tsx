    ...
    <article className="max-w-3xl mx-auto">
      <div className="bg-slate-50 rounded-xl border border-slate-100 p-5 sm:p-6 mb-10">
        ...
        <p className="text-sm sm:text-[15px] text-slate-600 leading-relaxed">
          At RemoteTalent, we believe in transparency and the protection of your personal
      ...
      <section className="mb-10">
        ...
        <p className="text-sm sm:text-[15px] text-slate-600 leading-relaxed mb-5">
          ...
          experience on the RemoteTalent platform.
        </p>
        <ul className="space-y-4">
      ...
      <section className="mb-10">
        ...
        <p className="text-sm sm:text-[15px] text-slate-600 leading-relaxed">
          RemoteTalent uses cookies and similar tracking technologies to track activity on our
