...
export function HiredWorkerList({
  ...
  const [sortKey, setSortKey] = useState<HiredSortKey>("newest");
  ...
  }, [workers, searchQuery, statusFilter, typeFilter, sortKey]);
  ...
  return (
    <div className="space-y-6">
      ...
      {filteredWorkers.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-sm space-y-3">
