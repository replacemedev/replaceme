    ...
    <main className={`bg-slate-50/50 min-h-[calc(100vh-4rem)] py-8 md:py-12 lg:py-16 ${PUBLIC_PAGE_TOP}`}>
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4 mt-6">
          ...
          <div className="mt-10 pt-8 border-t border-slate-200/80 animate-pulse">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div className="space-y-2 min-w-0">
                <SkeletonBlock className="h-6 w-32 rounded-full bg-slate-200" />
                <SkeletonBlock className="h-7 sm:h-8 w-64 rounded-xl bg-slate-200" />
                <SkeletonBlock className="h-4 w-96 max-w-full rounded-md bg-slate-100" />
              </div>
              <SkeletonBlock className="h-9 w-36 rounded-xl bg-slate-200 shrink-0 self-start sm:self-center" />
            </div>
            ...
            <div className="space-y-4">
              {Array.from({ length: 4 }).map((_, idx) => (
                <div
                  key={idx}
                  className="bg-white p-5 md:p-6 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-start gap-4 md:gap-5 animate-pulse"
                >
                  ...
                  <div className="flex-1 min-w-0 w-full space-y-2.5">
                    ...
                    <SkeletonBlock className="h-4 w-full rounded-md bg-slate-100" />
                    <SkeletonBlock className="h-4 w-4/5 rounded-md bg-slate-100" />
                    <div className="bg-slate-50/80 rounded-xl p-3 sm:p-3.5 border border-slate-100 space-y-2">
                      <SkeletonBlock className="h-3.5 w-11/12 rounded-md bg-slate-100" />
          ...
          <div className="mt-10 bg-slate-900 rounded-2xl p-6 sm:p-8 md:p-10 shadow-xl animate-pulse space-y-4">
            <SkeletonBlock className="h-6 w-40 rounded-full bg-slate-800" />
