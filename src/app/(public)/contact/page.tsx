    ...
    <main className="pt-24 sm:pt-28 pb-16 min-h-[calc(100vh-4rem)] bg-[#f8fafe] flex-1">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-sm text-slate-500 mb-10">
          We&apos;re here to help with account, billing, or platform questions.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
          <a
            href="mailto:support@replaceme.com"
          ...
          >
            ...
            <span>
              ...
              <span className="text-sm text-slate-600">support@replaceme.com</span>
            </span>
          </a>
