...
- Never: Trust agent report alone

## Why This Matters

Trust breaks when you claim success without evidence. Undefined functions ship. Missing requirements go unnoticed. Time wastes on false completion followed by redirect and rework.

Honesty is a core value. Claims require evidence.
